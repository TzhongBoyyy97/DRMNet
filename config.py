...
train_config = {
    ...
    'train_set_list': ['/data/ltz-dg/filelist/multi_filelists/filelist_train.npy',
                      '/data/ltz-dg/filelist/PN9_filelists_712/filelist_train.npy',
                      '/data/ltz-dg/filelist/ggo_filelists/filelist_train.npy'],
    'val_set_list': ['/data/ltz-dg/filelist/luna16_filelists/filelist_val.npy'],
    # 'val_set_list': ['/data/ltz-dg/filelist/PN9_filelists_712/filelist_val.npy',
    #                 '/data/ltz-dg/filelist/ggo_filelists/filelist_val.npy',
    #                 '/data/ltz-dg/filelist/luna16_filelists/filelist_val.npy'],
    'test_set_name': ['/data/ltz-dg/filelist/luna16_filelists/filelist_test.npy',
                    '/home/data2/ltz/domain_adaptation/filelist/multi_filelists/filelist_test.npy',
                    '/home/data2/ltz/domain_adaptation/filelist/PN9_filelists_712/filelist_test.npy'],
    'train_anno': ['/data/ltz-dg/filelist/multi_filelists/train_annos.csv',
               '/data/ltz-dg/filelist/PN9_filelists_712/train_annos.csv',
                '/data/ltz-dg/filelist/ggo_filelists/train_annos.csv',
                  ],
    'val_anno': ['/data/ltz-dg/filelist/luna16_filelists/val_annos.csv'],
    # 'val_anno': ['/data/ltz-dg/filelist/PN9_filelists_712/val_annos.csv',
    #            '/data/ltz-dg/filelist/ggo_filelists/val_annos.csv',
    #             '/data/ltz-dg/filelist/luna16_filelists/val_annos.csv',
    #               ],
    'train_dir': ['/data/ltz-dg/preprocess_result_multi',
                '/data/ltz-dg/PN9_1000',
                '/data/ltz-dg/preprocess_result_ggo'],
    'val_dir':['/data/ltz-dg/preprocess_result_luna16'],
    # 'val_dir':['/data/ltz-dg/PN9_1000',
    #             '/data/ltz-dg/preprocess_result_ggo',
    #             '/data/ltz-dg/preprocess_result_luna16'],
    'ROOT_DIR': os.getcwd()
}
...
train_config['out_dir'] = os.path.join(train_config['RESULTS_DIR'], 'puretrain2multi')
